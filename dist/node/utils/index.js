...
var Cache = /** @class */ (function () {
    function Cache() {
        this.key = '@suen/music-api/store';
        this.store = isBrowser ?
    ...
    Cache.prototype.set = function (key, value, timeout) {
        if (timeout === void 0) { timeout = 24 * 60 * 60 * 1000; }
        this.store[key] = {
            value: value,
